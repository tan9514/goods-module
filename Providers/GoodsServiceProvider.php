...
class GoodsServiceProvider extends ServiceProvider
{
     ...
     */
    protected $moduleNameLower = 'goods';
    ...
    {
        $this->moduleConfigArr = [
            "common" => $this->moduleNameLower . "common",
    ...
    protected function registerConfig()
    {
        ...
        $this->mergeConfigFrom(
            module_path($this->moduleName, 'Config/config.php'), $this->moduleConfigArr["config"]
        );
        $this->mergeConfigFrom(
            module_path($this->moduleName, 'Config/common.php'), $this->moduleConfigArr["common"]
        );
    }
